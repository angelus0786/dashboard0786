...
layout = dbc.Container([
    ...
    dbc.Row([
       dbc.Col([
           # dbc.Label("Ingrese Matrícula del Estudiante:"),
            dbc.Input(id='filtro_username', type='text', placeholder='Matrícula del Estudiante Ej. 22050003') #, debounce=True
        ], md=4),
    ...
    dbc.Row([
        dbc.Col(dbc.Card([
            dbc.CardHeader(
               html.H5("📊 Edad vs Situación Laboral", className="mb-0"),
        ...
        dbc.Col(dbc.Card([
            dbc.CardHeader(
                 html.H5("👥 Situación Laboral vs Estado Civil", className="mb-0"),
                 className="bg-success text-white"
            ),
            dbc.CardBody(
    ...
    dbc.Row([
        dbc.Col(dbc.Card([
            dbc.CardHeader(
                html.H5("🤝 Situación Laboral vs Relación con Amigos", className="mb-0"),
                className="bg-success text-white"
            ),
            dbc.CardBody(
        ...
        dbc.Col(dbc.Card([
            dbc.CardHeader(
                html.H5("🎓 Grado de Estudio: Padre vs Madre", className="mb-0"),
                className="bg-success text-white"
            ),
            dbc.CardBody(
 ...
 # Añadir marcadores para el estudiante seleccionado
    if username:
        ...
        if not estudiante_df.empty:
            ...
            dbc.Col(dbc.Card([
                dbc.CardHeader(
                    html.H5("📈 Calificación", className="text-white mb-0"),
            ...
            dbc.Col(
                dbc.Card([
                    dbc.CardHeader(
                        html.H5("🎂 Edad", className="text-white mb-0"),
                        className="bg-primary"),
            ...
            dbc.Col(
                dbc.Card([
                    dbc.CardHeader(
                        html.H5("💍 Estado Civil", className="text-white mb-0"),
                        className="bg-primary"), 
            ...
            dbc.Col(
                dbc.Card([
                    dbc.CardHeader(
                        html.H5("🤝 Relación con Amigos", className="text-white mb-0"),
                        className="bg-primary"
                    ), 
        ...
        alerta_global = dbc.Alert("✅ Mostrando datos globales", color="success", dismissable=True, className="w-100 text-center")
